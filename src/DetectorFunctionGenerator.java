...
public class DetectorFunctionGenerator {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < Detector.detectors.size(); i++) {
            ...
            System.out.printf("setblock %d 36 %d chain_command_block facing=up,conditional=true replace {auto:1b,Command:\"scoreboard players set lutLast messConstants %d\"}%n", detector.x, detector.z, LUT.getLUTValue((i==0 ? Detector.detectors.size()-1 : i-1)));
